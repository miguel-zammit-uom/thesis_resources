...
def _crossover_selection(population, fitnesses, C_r):
    ...
    if len(population) == len(fitnesses):
        ...
        # Select Best Performer (Max Value) for Obj 1 and Obj 2 (Mean value for 3 clf fitnesses)
        ...
        # Select Worst Performer (Min Value) for Obj 1 and Obj 2 (Mean value for 3 clf fitnesses)
